...
def main():
  ...
  options = Options() # a version where we modify the options to specify the path to Chrome browser executable
  options.binary_location = "/opt/google/chrome/google-chrome"

  driver = webdriver.Chrome(executable_path="./chromedriver", chrome_options=options) # create a driver object
